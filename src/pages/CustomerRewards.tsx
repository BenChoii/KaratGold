...
import { ArrowUpRight, TrendingUp, Clock, CheckCircle2, X, ShieldCheck, ExternalLink } from 'lucide-react'
                    ...
                    >
                        ...
                        >
                            <div className="cashout-modal-header">
                                <h3 className="text-h3">Cash Out Gold</h3>
                            ...
                            <div className="cashout-modal-footer">
                                <button
                                    ...
                                    onClick={async () => {
                                        ...
                                        if (!cadAmt || cadAmt <= 0 || cadAmt > balance.balanceCAD || !convexUser || !walletAddress.trim()) return
